            ...
            <form class="validation-form" method="post" action="${pageContext.request.contextPath}/member/edit.do" novalidate>
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" class="form-control" id="memberNickname" name="memberNickname" value="${ member.memberNickname }" required
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="email" class="form-control" id="memberEmail" name="memberEmail" placeholder="you@example.com" value="${ member.memberEmail }" readonly>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="memberZonecode" name="memberZonecode" value="${ member.memberZonecode }" required readonly>
                        <div class="invalid-feedback">
                            우편번호를 검색해 주세요.
                        </div>
                    </div>
